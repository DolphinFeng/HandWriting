<template>
    <div class="template-table">
        <div class="rg-table__header">
            ...
            <mtd-button
                v-if="!(this.api === 'Announcement' && this.list.length > 0)"
        ...
        <div class="rg-template__pagination" v-if="this.api!=='Announcement'">
            <mtd-pagination
                :total="tn"
                show-quick-jumper
                show-size-changer
...
import SpaceTemplateModal from './spaceTemplateModal.vue';
