...
class MyCreatedList extends Component<IProps, IState> {
  ...
  static navigationOptions = ({ navigation }) => ({
    title: i18nClient.t('components_home_6e871a', { defaultValue: '我发起的' }),
  ...
  constructor(props) {
    ...
    this.state = {
      pageType: TTHomePageType.created,
