...
import BaiduMercatorProjection from './baidu-mercator-projection';
import CoordTransform from '../../transform/coord-transform';
import {
  ...
  constructor(options) {
    ...
    this._projection.unproject = function (cartesian, result) {
      ...
      return new Cartographic(
        CMath.toRadians(result[0]),
        CMath.toRadians(result[1])
      );
    };
