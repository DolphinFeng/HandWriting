  ...
  <div id="div_outside">
    ...
    <div id="login_div">
      <div slot="logo" style="height: 40px; display: flex; justify-content: center; margin-top: 30px">
        ...
        <div class="login-title">标注平台</div>
      </div>
      <div id="login_form">
        <el-form :model="form">
          ...
          <el-form-item style="margin-top: 24px">
            <el-button :loading="loading" size="default" style="width: 200px" type="primary" @click="loginHandler"
              >登录</el-button
            >
          </el-form-item>
        </el-form>
...
import {queryClone} from '../router/router.js';
    ...
    .then((res) => {
      if (res.data.code === 0) {
        let data = res.data.data,
          token = data.token,
          realName = data['currentAccountName'];
