<template>
  <div id="ProjectDetailHistory">
    ...
    <el-row :gutter="10"><el-button :icon="Refresh" @click="refresh" style="margin: 0 5px">刷新</el-button></el-row>
    <el-row :gutter="10">
      <el-col :span="12" style="height: 650px">
          <div class="second-order">

            <div id="container" :style="{ width: '100%', height: '100%'}" @mousedown="startResize" ref="container"></div>
          </div>
      </el-col>
      <el-col :span="12"  style="height: 650px">
