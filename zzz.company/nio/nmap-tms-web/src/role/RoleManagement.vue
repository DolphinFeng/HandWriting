  ...
  export default {
    ...
    methods: {
      ...
      handlePermission(row) {
        ...
        this.checked = [];
        axios({
          url: nioUrl + '/permi/v1/queryPermsByRoleId',
          method: 'post',
          data: {
            "roleId": this.roleId,
          },
      ...
      permissionSetting() {
        ...
        // 调接口，编辑角色
        axios({
          url: nioUrl + '/user/v1/updatePermissions',
          method: 'post',
          data: {
            "roleId": this.roleId,
            "permIds": permIds
      ...
      loadingPage() {
        axios({
          url: nioUrl + '/user/v1/queryPageRole',
          method: 'post',
          data: {
      ...
      getPermData() {
        // 获取所有菜单权限数据集
        axios({
          url: nioUrl + '/permi/v1/queryAllPerm',
          method: 'post',
          data: {},
          headers: {'Authorization': this.token},
        }).then(response => {
