...
import {Cartesian2, WebMercatorTilingScheme, Event, DeveloperError, ImageryProvider} from 'cesium';
...
const TILE_URL = {
  ...
  custom:
    `//${window.api.apiMapBDWMTSImageryProvider}?&x={x}&y={y}&z={z}&scale=1&customid={style}`,
  traffic:
