...
import {PolylineGlowMaterialProperty, Color, CallbackProperty, Cartesian3, ColorMaterialProperty} from 'cesium';
...
export const createHighlightLineEntity = function (coordinates) {
  ...
  let loc_pos = Cartesian3.fromDegrees(coordinates[0][0], coordinates[0][1], 500);
