...
import {baseMapConPaneldata, BASE_MAP_SOURCE_LIST, BASE_MAP_SOURCE, setHdOptionExp} from './BaseMapConditionPanel.ts';
import {layerListItems} from '../../../system/layer/layerController.js';
import {hdSpecLayerOption} from '../../../system/layer/tileLayer/tileLayerController.js';

const items1 = layerListItems.items.slice(0, 3 + hdSpecLayerOption.length);
